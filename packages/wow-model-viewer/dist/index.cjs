...
function AnimationDebugPanel({ viewer }) {
  ...
  if (animations.length === 0) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.loading, children: "Loading animations..." });
  }
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.title, children: "Animation Debug" }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "select",
      {
        ...
        style: styles.select,
        children: animations.map((a) => /* @__PURE__ */ jsxRuntime.jsx("option", { value: a, children: a }, a))
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx("button", { onClick: togglePause, style: styles.button, children: paused ? "\u25B6 Play" : "\u23F8 Pause" }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.info, children: [
      animations.length,
...
function WowModelViewer({
  ...
  const idRef = react.useRef(`model-viewer-${Math.random().toString(36).slice(2, 9)}`);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { position: "relative", overflow: "hidden", width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ref: containerRef,
    ...
    debug && viewerReady && viewerRef.current && /* @__PURE__ */ jsxRuntime.jsx(AnimationDebugPanel, { viewer: viewerRef.current })
  ] });
}
...
function useDisplayIds(itemIds, options) {
  var _a;
  const [displayInfos, setDisplayInfos] = react.useState({});
  const baseUrl = (_a = options == null ? void 0 : options.baseUrl) != null ? _a : "/api/wowhead-display-id";
  const getDisplayInfo = react.useCallback(
...
exports.INVENTORY_TYPE = INVENTORY_TYPE;
exports.NOT_DISPLAYED_SLOTS = NOT_DISPLAYED_SLOTS;
exports.RACE_IDS = RACE_IDS;
exports.VIEWER_SLOT_MAP = VIEWER_SLOT_MAP;
exports.WowModelViewer = WowModelViewer;
exports.fetchDisplayInfo = fetchDisplayInfo;
exports.useDisplayIds = useDisplayIds;
